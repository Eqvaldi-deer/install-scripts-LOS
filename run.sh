...
do
    case $choice in
		...
		do
            ...
            ;;
        9)
            apt install kde-plasma-desktop systemsettings plasma-workspace plasma-workspace-wayland kwin-x11 kwin-wayland kwrite kdenetwork kcolorchooser kde-spectacle kgamma5 plasma-pa --no-install-recommends -y
